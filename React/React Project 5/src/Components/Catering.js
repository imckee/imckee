...
function Catering(){
    return (
        <div>
            <h1>Contact Us</h1>
            <p>Do you need to place an online order? Fill out this form and we'll get your order ready!
                (Note: please do not use this form to complain about the quality of our food.)
            </p>
                ...
                <input type="email" id="email" name="email" placeholder="blah@email.com"/><br/><br/>

                <label for="fName">Phone Number:</label><br/><br/>
                <input type="text" id="fName" name="fName" placeholder="777-777-7777"/><br/><br/>
